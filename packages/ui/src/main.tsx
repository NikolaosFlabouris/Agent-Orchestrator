 ...
 *
 *  LiveDataProvider sits between the gate and the <Outlet> for the same
 *  reason: it owns the single dashboard WebSocket, so the feed opens once
 *  identity is known and survives every route change below it. */
